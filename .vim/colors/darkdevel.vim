...
" -------------------
  ...
  highlight String            ctermfg=LightBlue   guifg=#64C896
...
" ---------------------
  ...
  highlight Keyword           ctermfg=LightGreen     guifg=#C86432
  highlight link Exception    Statement

" Style for generic preprocessor
" ------------------------------
  highlight PreProc           ctermfg=5        guifg=#DCDCDC     ctermbg=NONE      guibg=NONE
  highlight Include           ctermfg=Red     guifg=#C86432     ctermbg=NONE      guibg=NONE
...
" ---------------------------
  highlight Type              ctermfg=lightgreen     guifg=#DC4B32     gui=NONE
